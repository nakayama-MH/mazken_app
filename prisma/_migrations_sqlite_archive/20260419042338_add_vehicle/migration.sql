...
INSERT INTO "new_assignments" ("assignmentType", "createdAt", "dailyRateOverride", "endDate", "endTime", "id", "jobSiteId", "notes", "shiftType", "staffId", "startDate", "startTime", "updatedAt") SELECT "assignmentType", "createdAt", "dailyRateOverride", "endDate", "endTime", "id", "jobSiteId", "notes", "shiftType", "staffId", "startDate", "startTime", "updatedAt" FROM "assignments";
